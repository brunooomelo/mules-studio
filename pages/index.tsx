  ...
  return (
    <div className="w-full xl:container xl:mx-auto">
      ...
      <main className="flex flex-col items-center bg-secondary py-20 xl:flex-row xl:rounded-2xl">
        <div className="">
          {!isEnableSale ? (
            <div className="rounded-3xl border-4 border-white p-8 text-white font-bold md:text-5xl w-full text-center my-4 ">
            ...
            <>
              <div className="px-4 text-center">
                ...
                <p className="w-3/4 mx-auto text-white my-5 text-center text-base sm:text-xl">
                  Mules is a collection of 1337 uniquely and randomly NFTs
                  stored on Fantom Network
                </p>
              </div>
